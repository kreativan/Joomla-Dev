...
/**
 * Methods supporting a list of Kontrol_panel records.
 */
class Kontrol_panelModelKpitems extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_kontrol_panel');
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__kontrol_panel` AS a');
