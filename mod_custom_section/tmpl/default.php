...
<div <?php echo $ivm_css_id;?> class="ivm-custom-section<?php echo $ivm_class;?>" style="background:url(<?php echo $ivm_bg;?>);background-size:cover;background-repeat:no-repeat;background-position:center;">
