    ...
    <div class="uk-grid uk-grid-divider uk-form uk-form-stacked" data-uk-grid-margin>
        ...
        <div ng-class="vm.name == 'contentCtrl' ? 'wk-width-xlarge-3-4' : ''" class="uk-width-medium-2-3" ng-show="item">
            ...
            <div class="uk-form-row">
             ...
             <div class="uk-form-row">
                <label class="uk-form-label" for="wk-subtitle">{{'Position' | trans}}</label>
                <div class="uk-form-controls">
                    <input id="wk-position" class="uk-width-1-1" type="text" ng-model="item.position">
                </div>
            </div>
            ...
            <div class="uk-form-row">
                <label class="uk-form-label" for="wk-link">{{'Linked In' | trans}}</label>
                <div class="uk-form-controls">
                    <field type="text" options='{"attributes":{"id":"wk-link", "placeholder":"https://www.linkedin.com/"}, "icon":"linkedin"}' ng-model="item.linkedin"></field>
                </div>
            </div>
            
            <div class="uk-form-row">
                <label class="uk-form-label" for="wk-link">{{'Twitter' | trans}}</label>
                <div class="uk-form-controls">
                    <field type="text" options='{"attributes":{"id":"wk-link", "placeholder":"https://www.twitter.com/"}, "icon":"twitter"}' ng-model="item.twitter"></field>
                </div>
            </div>
